import { DetailSectionProps, NestingContentProps } from "@/types/types";

export const PART_1: NestingContentProps[] = [
  {
    key: 1,
    mainTitle: "Check",
    content: [
...
export const PART_2: NestingContentProps[] = [
  {
    key: 1,
    mainTitle: "Check",
    content: [
...
export const PART_3: NestingContentProps[] = [
  {
    key: 1,
    mainTitle: "Check",
    content: [
...
export const PART_4: NestingContentProps[] = [
  {
    key: 1,
    mainTitle: "Check",
    content: [
...
export const DETAIL_SECTIONS: DetailSectionProps[] = [
  {
    key: 1,
