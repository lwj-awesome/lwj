  ...
  return (
    <>
      <div className="sm:p-[10rem] p-[1.2rem] animate-fadeUp w-full">
        ...
        <article className="sm:flex sm:flex-row  gap-custom-gap-md flex flex-col">
          ...
          <div className={commonContentStyle}>
            ...
            <Text.description>
              ...
              페이지에서는 장애 이력 관리, 업무 요청 현황 확인, 상태 변경 처리
              등 복수의 ITSM 업무를 통합적으로 제어할 수 있어 운영 효율성을
              높였습니다.
            </Text.description>
          </div>
        </article>
        ...
        <article className="sm:flex sm:flex-row  gap-custom-gap-md flex flex-col sm:mt-[4rem]">
          <img className={commonImageStyle} src="images/see.jpg" alt="" />
          <div className={commonContentStyle}>
            <Text.subTitle>
            ...
            <Text.description>
              ...
              자체적인 도메인을 가지되, 내부적으로는 공통 유틸리티, 타입 정의,
              UI 컴포넌트를 공유할 수 있도록 packages/ 단위로 구성하여 중복
              방지와 통일성을 확보했습니다.
            </Text.description>
            <Text.description>
              ...
              UI/UX를 유지할 수 있도록 하였습니다. 이러한 구조는 기능별 책임
              분리, 배포 속도 향상, 서비스 확장성 확보에 크게 기여하였으며, 실제
              운영 환경에서도 안정적인 병합 및 서비스 연결을 가능하게 했습니다.
            </Text.description>
          </div>
        </article>
      </div>
